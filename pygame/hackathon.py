...
class BarObject(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load('images/bar_new.png')
        self.image = pygame.transform.scale(self.image, (603, 350))
        self.rect = self.image.get_rect(topleft = (1250, 754))
...
clickedItemIndex = 0
cycle = [
    CycleObject(CYCLE_ITEM_POS_X, CYCLE_ITEM_POS_Y, 'images/fill.png', 0),
    CycleObject(CYCLE_ITEM_POS_X + CYCLE_ITEM_OFFSET_W, CYCLE_ITEM_POS_Y, 'images/wash.png', 1),
    CycleObject(CYCLE_ITEM_POS_X + CYCLE_ITEM_OFFSET_W * 2, CYCLE_ITEM_POS_Y, 'images/spin.png', 2),
    CycleObject(CYCLE_ITEM_POS_X + CYCLE_ITEM_OFFSET_W * 3, CYCLE_ITEM_POS_Y, 'images/rinse.png', 3)
]
cycle_group = pygame.sprite.RenderPlain(*cycle)

item = [
    [
        InventorySlotObject('images/potion_fill.png', ( 41, 162), 0),
        InventorySlotObject('images/potion_fill.png', (139, 162), 1),
        InventorySlotObject('images/potion_fill.png', (238, 162), 2),
        InventorySlotObject('images/potion_fill.png', ( 41, 248), 3),
        InventorySlotObject('images/potion_fill.png', (139, 248), 4)
    ],
    [
        InventorySlotObject('images/potion_wash.png', ( 41, 162), 0),
        InventorySlotObject('images/potion_wash.png', (139, 162), 1),
        InventorySlotObject('images/potion_wash.png', (238, 162), 2),
        InventorySlotObject('images/potion_wash.png', ( 41, 248), 3),
        InventorySlotObject('images/potion_wash.png', (139, 248), 4)
    ],
    [
        InventorySlotObject('images/potion_spin.png', ( 41, 162), 0),
        InventorySlotObject('images/potion_spin.png', (139, 162), 1),
        InventorySlotObject('images/potion_spin.png', (238, 162), 2),
        InventorySlotObject('images/potion_spin.png', ( 41, 248), 3),
        InventorySlotObject('images/potion_spin.png', (139, 248), 4)
    ],
    [
        InventorySlotObject('images/potion_rinse.png', ( 41, 162), 0),
        InventorySlotObject('images/potion_rinse.png', (139, 162), 1),
        InventorySlotObject('images/potion_rinse.png', (238, 162), 2),
        InventorySlotObject('images/potion_rinse.png', ( 41, 248), 3),
        InventorySlotObject('images/potion_rinse.png', (139, 248), 4)
    ]
]
item_groups = [
